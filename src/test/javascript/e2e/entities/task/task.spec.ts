...
describe('Task e2e test', () => {
    ...
    it('should load Tasks', async () => {
        ...
        expect(await taskComponentsPage.getTitle()).to.eq('jhipsterSandBoxApp.task.home.title');
    });

    it('should load create Task page', async () => {
        await taskComponentsPage.clickOnCreateButton();
        taskUpdatePage = new TaskUpdatePage();
        expect(await taskUpdatePage.getPageTitle()).to.eq('jhipsterSandBoxApp.task.home.createOrEditLabel');
    ...
    it('should create and save Tasks', async () => {
        ...
        await taskUpdatePage.customerSelectLastOption();
    ...
    it('should delete last Task', async () => {
        ...
        expect(await taskDeleteDialog.getDialogTitle()).to.eq('jhipsterSandBoxApp.task.delete.question');
